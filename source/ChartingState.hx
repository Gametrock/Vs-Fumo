...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var check_breakInput1:FlxUICheckBox;
	var check_breakInput2:FlxUICheckBox;
	var check_breakInput3:FlxUICheckBox;
	var check_breakInput4:FlxUICheckBox;
	...
	function addSectionUI():Void
	{
		...
		check_breakInput1 = new FlxUICheckBox(10, 190, null, null, "Break Left Input", 100);
		check_breakInput1.name = 'breakInput1';

		check_breakInput2 = new FlxUICheckBox(10, 210, null, null, "Break Down Input", 100);
		check_breakInput2.name = 'breakInput2';

		check_breakInput3 = new FlxUICheckBox(10, 230, null, null, "Break Up Input", 100);
		check_breakInput3.name = 'breakInput3';

		check_breakInput4 = new FlxUICheckBox(10, 250, null, null, "Break Right Input", 100);
		check_breakInput4.name = 'breakInput4';
		...
		tab_group_section.add(check_breakInput1);
		tab_group_section.add(check_breakInput2);
		tab_group_section.add(check_breakInput3);
		tab_group_section.add(check_breakInput4);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		if (id == FlxUICheckBox.CLICK_EVENT)
		{
			...
			switch (label)
			{
				...
				case "Break Left Input":
					_song.notes[curSection].breakInput1 = check.checked;
				case "Break Down Input":
					_song.notes[curSection].breakInput2 = check.checked;
				case "Break Up Input":
					_song.notes[curSection].breakInput3 = check.checked;
				case "Break Right Input":
					_song.notes[curSection].breakInput4 = check.checked;
			}
		}
	...
	function updateSectionUI():Void
	{
		...
		check_breakInput1.checked = sec.breakInput1;
		check_breakInput2.checked = sec.breakInput2;
		check_breakInput3.checked = sec.breakInput3;
		check_breakInput4.checked = sec.breakInput4;
	...
	private function addNote(?n:Note):Void
	{
		...
		if (n != null)
			_song.notes[curSection].sectionNotes.push([n.strumTime, n.noteData, n.sustainLength, n.damageNote, n.timeNote, n.noNameNote]);
		else
			_song.notes[curSection].sectionNotes.push([noteStrum, noteData, noteSus, noteKnife, noteTime, noteUnnamed]);
