...
class LoadReplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		addWeek(['Introcirno', 'Mist-Lake', 'Scarlet-Police', 'Beloved-Tomboyish-Girl'], 7, ['dad-xd' ,'cirno', 'cirno', 'cirno']);
		addWeek(['Dream-Battle'], 8, ['reimu']);
		addWeek(['Sakuya', 'Lunar-Clock', 'Night-Of-Nights', 'Night-Of-Cranky-Remix'], 9, ['sakuya', 'sakuya', 'sakuya', 'sakuya-mad']);
